...
// maskPersonName — "Алексей Иванов" → "Алексей И*****": первое слово
// (имя) без изменений, остальные слова (фамилия/отчество) маскируются.
// Один непонятный формат ("Иванов" без имени) — то же правило, что и
// одно слово: маскируется как maskWord.
