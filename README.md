...
> 🚀 **Демонстрационный стенд:** [https://газвпол.рус/console/app](https://xn--80aebrvrg.xn--p1acf/console/app)
...
## Возможности веб-консоли

Веб-консоль ADP — операционный и **low-code слой** платформы: автоматизации, маршрутизация и правила настраиваются визуально, без изменения backend-кода.

- **Low-code сценарии:** визуальный граф из условий, уведомлений, ожиданий и ветвлений; выбор получателей, TrueConf/Email, активация версий и просмотр хода выполнения.
- **Low-code правила:** конструктор вложенных фильтров «ВСЕ/ЛЮБОЕ», настройка SLA, групп, зон ответственности, графиков доступности и дежурств.
- **Операционная работа:** единое представление алертов, инцидентов, оборудования, сотрудников и разрывов покрытия.
- **Аналитика:** SLA, MTTA/MTTR, доставка и реакции на уведомления, эффективность сценариев.
- **Администрирование:** источники и интеграции, роли и права доступа, аудит, история изменений и состояние компонентов платформы.
